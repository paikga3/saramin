...
<table id="screen2" style="display: none; margin-left: auto; margin-right: auto;">
    ...
    <tr>
		<td><input type="button" value="a. 러브 로맨스 소설" class="a2" data-score="2"/></td>
		<td><input type="button" value="b. 엽기 공포 소설" class="a2" data-score="1"/><!-- 0.5점씩 --></td>
		<td><input type="button" value="c. 모른다" class="a2" data-score="0"/></td>
	</tr>
</table>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("tr:eq(0) > td:eq(0)").css("background","#D4F4FA");
	});
